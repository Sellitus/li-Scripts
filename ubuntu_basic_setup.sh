...
if [[ $serverChoice == "y" ]]; then
	...
	sudo echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPuPn0cnBDl7BOEecgcbrWvM+dIBuKZZaRYRMqoYv2Aw sellitus@ss-MacBook-Pro.local" > /home/$username/.ssh/authorized_keys
